/**
  ...
  * FileName: GetMessageCode 
  * Author:   r  
  * Date:     2018/11/2 8:33 PM 
  */
...
public class GetMessageCode {
    ...
    private static final String ACCOUNT_SID="518a2b1a986a4e348efea7be7e072694";
    private static final String AUTH_TOKEN="46e38d2ef9224d1f8bf32b51a445ec73";
    //根据相应的手机号发送验证码
    public static String getCode(String phone){
        String rod=smsCode();
        String timestamp=getTimestamp();
        String sig=getMD5(ACCOUNT_SID,AUTH_TOKEN,timestamp);
        String tamp="【成都东软学院】登录验证码："+rod+"，如非本人操作，请忽略此短信。";//这里一定要与新建模板中的短信内容一致，一个空格都不能多，否者短信打死都发不过去哦
