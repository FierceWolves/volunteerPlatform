		...
		<div class="group-information-wrap">
			...
			<div class="information-table-wrap">
				<table class="information-table">
					...
					<tr>
						<td class="dissolve-btn-wrap" colspan="2">
							<button type="submit" class="ensure-btn" onclick="ensureDissolve()">确认解散</button>
							<button class="cancel-btn" onclick="alert('取消解散')">取消</button>
						</td>
					</tr>
				</table>
			</div>
