					...
					<div class="order-address-wrap">
						...
						<div class="order-information-content">
							<div class="delivery-information">
								<span class="delivery-number-title">运单号:</span>
								<span class="em" id="delivery-number">889817765287731019</span>&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="delivery-method-title">物流公司:</span>
								<span class="em" id="delivery-method">圆通速递</span>
							</div>
							<div class="ship-address">
								<span class="ship-address-title">发货地址：</span>
								<span class="ship-address" id="shipAddress">广东省深圳市龙岗区坂田街道办里浦街7号德众工业园6栋202</span>
								<span class="postcode em" id="postcode">518000</span>
								<span class="shipper em" id="shipper">爱立佳</span>
								<span class="phone-number em" id="phoneNumber">075585225757</span>
							</div>
							<div class="delivery-address">
								<span class="delivery-address-title">收货地址：</span>
								<span class="delivery-address" id="shipAddress">四川省成都市都江堰市青城山镇东软大道1号（成都东软学院）</span>
								<span class="postcode em" id="postcode">635000</span>
								<span class="shipper em" id="shipper">余星*</span>
								<span class="phone-number em" id="phoneNumber">151****9862</span>
							</div>
						</div>
					</div>
					<div class="traces-detail-wrap">
						<h4><span id="address-title">物流信息</span></h4>
						<div class="traces-detail-content">
							<div class="traces-title">
								<span class="title-text">运输中</span>
							</div>
							<div class="traces-status">
								<ul id="statusList" class="status-list">
									<li><span class="date">2018-08-09</span><span class="week">周四</span><span class="time">15:57:13</span><span class="text">【金华市】您的包裹已由物流公司揽收</span></li>
									<li><span class="date  invisible">2018-08-09</span><span class="week invisible">周四</span><span class="time">16:38:21</span><span class="text">【金华市】快件已到达 义乌青口一分部集货点</span></li>
									<li><span class="date  invisible">2018-08-09</span><span class="week invisible">周四</span><span class="time">19:22:38</span><span class="text">【金华市】快件已到达 义乌转运中心</span></li>
									<li class="latest"><span class="date invisible">2018-08-09</span><span class="week invisible">周四</span><span class="time">20:20:56</span><span class="text">【金华市】快件已从义乌转运中心发出，准备发往成都市</span></li>
								</ul>
							</div>
						</div>
					</div>
